...
function LoadingMVR() {
    ...
    return isVisible ? (
        <div
            id="timeline-modal"
            tabIndex={-1}
            className="transition-all duration-100 ease-in-out overflow-y-auto flex overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full bg-black/50"
        >
